...
An AI-powered real estate analytics platform that helps users explore property markets, predict property prices, discover similar projects, and understand how different property features influence price.

The platform integrates machine learning, recommendation systems, data analytics, and interactive dashboards to provide meaningful insights from real estate data.

Built using Python, Machine Learning, and Streamlit, this project demonstrates a complete end-to-end data science workflow from data preparation to deployment.
